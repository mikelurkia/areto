...
import { db } from "@/db";
import { personDataConsents, seasons, teams } from "@/db/schema";
...
export default async function EquiposPage({
  ...
  const [currentTeams, dataConsentRows] = selectedSeason
    ? await Promise.all([
        ...
        db.query.personDataConsents.findMany({
          where: eq(personDataConsents.seasonId, selectedSeason.id),
