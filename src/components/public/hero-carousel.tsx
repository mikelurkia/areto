...
import { SproutIcon, TrophyIcon, UsersRoundIcon } from "lucide-react";
...
const SLIDES = [
  { key: "firstTeam", icon: TrophyIcon, tone: "primary", photo: "primer-equipo.jpg" },
  { key: "grassroots", icon: SproutIcon, tone: "gold", photo: "cantera.jpg" },
  { key: "wholeClub", icon: UsersRoundIcon, tone: "primary", photo: "cantera2.jpg" },
] as const;
